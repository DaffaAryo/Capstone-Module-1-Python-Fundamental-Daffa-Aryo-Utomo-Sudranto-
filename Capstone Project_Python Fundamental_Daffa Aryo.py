    ...
    while True:
        ...
        Masukan angka Menu Barang:
            ...
            if pilihan_menu_2 == 1:
                ...
                for barang in barang_toserba:
                    if id_barang.capitalize() == barang['id'] or nama_barang.capitalize() == barang['nama']:
                    ...
                    if pilih_barang_update == barang['id']:
                        ...
                        if confirm_update == 'yes':
                            pilih_update = int(input('''
                                \t Menu Update Barang
                                1. Update Data id Barang
                                2. Update Data nama Barang
                                3. Update Data stock Barang
                                4. Update Data harga Barang
                                5. Update Data total penjualan Barang
                                
                                Masukan angka Menu Update Barang:
                                '''))
                            if pilih_update == 1:
                                update_id = input('Masukan id barang baru: ')
                                barang['id'] = update_id
                            elif pilih_update == 2:
                            ...
                            if menyimpan_update == 'no': #masih salah, coba nanti tambahin varible baru untuk save data sebelum ada perubahan dari input
                                barang = copy_barang
